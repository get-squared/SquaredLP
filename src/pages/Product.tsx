  ...
  return (
    <Section>
      ...
      <div className="xl:mb-[21.875rem] xl:w-[66.5%] xl:mx-auto sm:mb-20 mb-8 ">
        <h3 className="font-bold text-center text-teal-400 font-sohne lg:text-h3 text-h5">Our vision</h3>
      ...
      <div className="mb-10 lg:mb-28 xl:mb-48">
        ...
        <div className="flex flex-col items-center justify-between gap-8 min-[1025px]:items-stretch min-[1025px]:flex-row 2xl:w-[70%] 2xl:mx-auto">
          ...
          <div className="flex flex-col justify-center items-center sm:w-96  text-center bg-gradient-medium rounded-[32px] px-10 py-12">
            <KeywordIcon />
            <h5 className="mb-3 text-white font-sohne xl:mt-10 lg:mt-6 text-h5">Keyword generator</h5>
            <p className="font-sans leading-7 text-grey-300 lg:text-p text-caption1">
          ...
          <div className="flex flex-col justify-center items-center sm:w-96 text-center bg-gradient-medium rounded-[32px] px-10 py-12">
            ...
            <h5 className="mb-3 text-white xl:mt-10 font-sohne lg:mt-6 text-h5">Product attributes</h5>
            <p className="font-sans leading-7 text-grey-300 lg:text-p text-caption1">
      ...
      <div className="mb-10 lg:mb-48 xl:mb-80">
        ...
        <div className="flex flex-col items-center justify-between gap-8 mb-10 lg:mb-48 lg:items-stretch lg:flex-row 2xl:w-[70%] 2xl:mx-auto">
          ...
          <div className="flex flex-col justify-center items-center text-center lg:w-1/2  w-full bg-gradient-medium rounded-[32px] px-10 py-12">
            <YourBrandVoiceIcon />
            <h5 className="mb-3 text-white lg:mt-10 font-sohne text-h5">Your brand voice</h5>
            <p className="leading-5 text-sans text-grey-300 lg:text-p text-caption1">
      ...
      <div className="lg:mb-44 mb-14">
        ...
        <div className="flex flex-col items-center justify-between gap-4 min-[1040px]:items-baseline min-[1040px]:flex-row 2xl:w-[70%] 2xl:mx-auto">
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <h5 className="w-64 font-sohne text-h5 text-grey-300">Amazon content and keyword experts</h5>
          </div>
          <PlusIcon />
          <div className="flex flex-col items-center justify-center text-center">
            <div className="rounded-full bg-gradient-medium p-14 w-[200px] h-[200px] mb-7 flex justify-center items-center">
            ...
            <h5 className="w-64 font-sohne text-h5 text-grey-300">Proprietary large language models</h5>
          </div>
        </div>
      </div>
