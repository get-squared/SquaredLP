  ...
  return (
    <section className="px-6 lg:px-24 sm:px-9">
      <div className="flex flex-col items-center lg:mb-[7.5rem] mb-10 gap-8">
        ...
        <h6 className="text-center text-white text-h6 font-base">Squared helps ecommerce professionals maximize their efficiency and output by turning artificial into ‘real’ intelligence</h6>
        <Link to={'/contact'}>
      ...
      <div>
        ...
        <div className="flex flex-col items-center justify-between gap-8 mb-10 lg:mb-48 min-[1025px]:items-stretch min-[1025px]:flex-row">
      ...
      <div className="mb-28 lg:mb-80">
        ...
        <div className="flex flex-col items-center justify-between gap-8 mb-10 lg:mb-48 lg:items-stretch lg:flex-row">
          <div className="flex flex-col justify-center items-center text-center lg:w-1/2  w-full bg-gradient-medium rounded-[32px] px-10 py-12">
            ...
            <p className="leading-5 text-grey-300 lg:text-p text-caption1">
